...
hash_check_tuples = (
    ...
    ('LatinoUS', old_process.Latino_USA),
    ('RevealWk', old_process.Reveal),
    ('SaysYou1', old_process.Says_You),
    ('SnapJudg', old_process.Snap_Judgment),
    ('THEMOTH', old_process.The_Moth),
    ('ThisAmer', old_process.This_American_Life)
)
